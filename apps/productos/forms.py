...
class formulario_categoria(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nombre": forms.TextInput(attrs={"class": "input"}),
            "descripcion": forms.Textarea(attrs={"class": "text_tarea_input"}),
        }


class formulario_ubicacion(forms.ModelForm):
    class Meta:
        model = Ubicacion
        ...
        labels = {
            "nombre": "Ubicacion",
            "detalle": "Detalle de ubicacion",
        }

        widgets = {
            "nombre": forms.TextInput(attrs={"class": "input"}),
            "detalle": forms.Textarea(attrs={"class": "text_tarea_input"}),
        }